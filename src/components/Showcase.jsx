...
const Showcase = ({display,title,itemId,useItemId}) => {
            ...
            return (
                <div className='w-full h-auto overflow-y-hidden my-20 m-auto rounded-md px-[15%]'>
                    <>
                    ...
                    <div className="container w-[100%] h-full flex gap-[2rem] justify-center py-[2%] my-[30px] flex-wrap mx-auto">
