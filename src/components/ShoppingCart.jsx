    ...
    return (
            <div className='h-auto w-auto flex justify-center items-center relative cursor-pointer'>
                <Link to= '/shoppingcart'>
                    <div className=' font-bold bg-black absolute top-[10px] left-[30px] w-[17px] h-[17px] flex items-center p-[4px] text-[0.7rem] justify-center text-white'>{cartItems}</div>
